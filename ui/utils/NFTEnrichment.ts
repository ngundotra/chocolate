...
export async function getNftMetadataAccountInfo(
...
export async function getNFTs(
    ...
    for (var i = 0; i < tokens.length; i++) {
        ...
        if (typeof metadataAccountInfo === "undefined") continue;
        ...
        try {
            ...
            console.error(
                "NFT enrichment failed for token: ",
                tokenInfo.address,
                " reason: ",
                e
            );
